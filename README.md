...
- **📂 Project-Root/**
  ...
  - **Evidence/** – Screenshots, logs, and proof-of-concept files
  - **Project-Planning/** – Proposal, Gantt chart, roles, KPIs, risk assessment
  - **Feedback-&-Evaluation/** – Lecturer feedback and suggested improvements
  - **User-Stories-&-Use-Cases/** – User stories, use case diagrams, flow explanations
  - **System-Analysis-&-Design/** – Network diagrams, architecture, workflows
  - **Nessus Results/** – Automated vulnerability scan reports
...
| 139/445 | SMB       | Open Shares / Weak Configuration           |
