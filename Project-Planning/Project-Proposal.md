...
- Perform vulnerability assessments on discovered services.
- Exploit selected vulnerabilities to demonstrate security impact.
- Document all steps, results, evidence, and remediation guidance.

## 3. Scope
**In-Scope:**  
- Virtual lab components: Metasploitable 2 (target) and Kali Linux (attacker).  
- Scanning, enumeration, exploitation,post exploitation and documentation.  
